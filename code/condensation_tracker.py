...
from helper import propagate, observe, resample, estimate
...
def condensation_tracker(video_name, params):
    ...
    for i in range(last_frame - first_frame + 1):
        ...
        hist_cur = color_histogram(min(max(0, round(mean_state_a_posteriori[i, 0]-0.5*bbox_width)), frame_width-1),
        ...
        hist = (1 - params["alpha"]) * hist + params["alpha"] * hist_cur
